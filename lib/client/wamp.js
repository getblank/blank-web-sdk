...
var _doubleApi2 = require("../doubleApi");

var _doubleApi3 = _interopRequireDefault(_doubleApi2);
...
var WampClient = function () {
    ...
    _createClass(WampClient, [{
        ...
        value: function connect(serverUrl, cb) {
            ...
            var Client = typeof WebSocket === "undefined" ? require("ws") : WebSocket;
        ...
        value: function call(url) {
            ...
            var _doubleApi = (0, _doubleApi3.default)(cb);

            promise = _doubleApi.promise;
            cb = _doubleApi.cb;
        ...
        value: function _wsOpenedHandler(e) {
            if (this._heartBeat) {
